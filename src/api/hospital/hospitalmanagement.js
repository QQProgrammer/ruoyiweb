...
// 列表
export function gethospInfoList(query) {
  return request({
    url: '/bussiness/hospInfo/list',
    method: 'get',
    params: query
  })
}
...
export function deldeleteHospInfoById(query) {
  ...
  // 新增医院
  export function createHospInfo(data) {
    return request({
      url: '/bussiness/hospInfo/createHospInfo',
      method: 'post',
      data: data
    })
  }
...
export function updateHospInfo(data) {
    return request({
      url: '/bussiness/hospInfo/updateHospInfo',
      method: 'put',
      data: data
    })
  }
